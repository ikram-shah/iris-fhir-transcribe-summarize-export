<template>
  <div>
    <div class="flex m-6">
      <button
        class="flex items-center justify-center bg-blue-500 text-white text-l font-medium py-2 px-4 rounded-md"
    ...
    <div v-if="transcription && summary" class="flex m-6">
      <div class="w-1/2 pr-4">
        ...
        <textarea
          class="w-full h-14 p-4 bg-gray-100 rounded-lg mb-4"
